...
t.module("ngSanitize",[]).provider("$sanitize",r),t.module("ngSanitize").filter("linky",["$sanitize",function(e){var n=/((ftp|https?):\/\/|(www\.)|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"\u201d\u2019]/i,r=/^mailto:/i;return function(o,a){function s(e){e&&p.push(i(e))}function u(e,n){p.push("<a "),t.isDefined(a)&&p.push('target="',a,'" '),p.push('href="',e.replace(/"/g,"&quot;"),'">'),s(n),p.push("</a>")}if(!o)return o;for(var c,l,f,h=o,p=[];c=h.match(n);)l=c[0],c[2]||c[4]||(l=(c[3]?"http://":"mailto:")+l),f=c.index,s(h.substr(0,f)),u(l,c[0].replace(r,"")),h=h.substring(f+c[0].length);return s(h),e(p.join(""))}}])}(window,window.angular),function(){var e,t;e=angular.module("app.controllers",[]),t=angular.element(window),e.controller("MainController",["$scope",function(e){return e.months=36,e.income=5600,e.expenses=2860,e.savings=8254,e.saving_perc="15%",e.assets=0,e.asset_perc="85%",e.range=function(t){return null==t&&(t=parseFloat(e.months)),new Array(t)},e.perc=function(t){return parseFloat(e[t+"_perc"])/100}}]),e.controller("Results",["$scope",function(e){var t,n,r,i;return i=t=n=0,r=function(){return parseFloat(e.income-e.expenses)*(e.$index+1)},e.r_savings=function(){var t;return i=parseFloat(e.savings),i+=r()*e.perc("saving"),t=parseFloat(3*e.expenses),i>t&&(n=parseFloat(i-t),i=parseFloat(t)),i},e.r_assets=function(){return t=parseFloat(e.assets),t+=n,t+=r()*e.perc("asset")},e.r_worth=function(){return i+t}}])}.call(this),function(){angular.element(document).ready(function(){return angular.module("app",["ngSanitize","app.controllers"]),angular.bootstrap(document,["app"])})}.call(this);